...
Parameter('ka4', 3.623188E-4)  # ka4 has units of molec.^-1 s^-1
Parameter('kd4', 0.3)
...
Parameter('k_d1', 0.030)

Parameter('k_a2', 8.30e-13)
Parameter('k_d2', 0.002)

Parameter('k_a3', 3.62e-4)
Parameter('k_d3', 2.4e-5)

Parameter('k_a4', 3.62e-4)
Parameter('k_d4', 0.006)
...
Parameter('kSOCS', 4E-3)  # Should sufficiently separate peak pSTAT from peak SOCS
Parameter('SOCSdeg', (5e-4)*5)  #  Maiwald*form factor
Parameter('kSOCSon', 1E-6)  # SOCS binding to IFNAR2
Parameter('kSOCSoff', 5.5E-4)  # Rate of SOCS unbinding IFNAR2
...
# Alpha
Rule('SOCS_inhibition', SOCS(site=None) + IFNAR2(re=WILD, ri=None, loc='out') | IFNAR2(re=WILD, ri=3, loc='out')%SOCS(site=3), kSOCSon, kSOCSoff)

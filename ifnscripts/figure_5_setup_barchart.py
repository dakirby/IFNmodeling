...
def figure_5_setup_barchart():
    ...
    names = ['R149A', 'A145G', 'L26A', 'YNSL153A', 'YNSM148A', 'YNS']  # IFNs of interest
    alt_names = ['IFNa2(R149A)', 'IFNa2(A145G)', 'IFNa2(L26A)', 'IFNa2(YNS,L153A)', 'IFNa2(YNS,M148A)', 'IFNa2(YNS)']  # names in FiguresS5.csv

...
if __name__ == '__main__':
    ...
    for idx, t in enumerate(times):
        if t not in alpha_mask:
            data_plot_dr.add_trajectory(newdata_4, t, 'scatter', alpha_palette_new[idx], (3, 0), 'Alpha', dn=1)
            data_plot_dr.add_trajectory(newdata_4, t, 'plot', '--', (3, 0), 'Alpha', dn=1, color=alpha_palette_new[idx], label='Alpha ' + str(t))
            data_plot_dr.add_trajectory(newdata_3, t, 'scatter', alpha_palette_new[idx], (2, 0), 'Alpha', dn=1)
            data_plot_dr.add_trajectory(newdata_3, t, 'plot', '--', (2, 0), 'Alpha', dn=1, color=alpha_palette_new[idx], label='Alpha ' + str(t))
        ...
        if t not in beta_mask:
            data_plot_dr.add_trajectory(newdata_4, t, 'scatter', beta_palette_new[idx], (3, 1), 'Beta', dn=1)
            data_plot_dr.add_trajectory(newdata_4, t, 'plot', '--', (3, 1), 'Beta', dn=1, color=beta_palette_new[idx], label='Beta ' + str(t))
            data_plot_dr.add_trajectory(newdata_3, t, 'scatter', beta_palette_new[idx], (2, 1), 'Beta', dn=1)
            data_plot_dr.add_trajectory(newdata_3, t, 'plot', '--', (2, 1), 'Beta', dn=1, color=beta_palette_new[idx], label='Beta ' + str(t))

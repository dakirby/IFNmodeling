...
# the pre-calculated value of IFN*volEC*NA to the parameter Ia
# =============================================================================
...
Observable('BoundSOCS', IFNAR1(re=1, ri=None, loc='out')%IFN_alpha2(r1=1,r2=2)%IFNAR2(re=2,ri=3,loc='out')%SOCS(site=3))
...
# Alpha
Rule('SOCS_inhibition', SOCS(site=None) + IFNAR1(re=1, ri=None, loc='out')%IFN_alpha2(r1=1, r2=2)%IFNAR2(re=2, ri=None, loc='out') | IFNAR1(re=1, ri=None, loc='out')%IFN_alpha2(r1=1, r2=2)%IFNAR2(re=2, ri=3, loc='out')%SOCS(site=3), kSOCSon, kSOCSoff)

...
Parameter('ka_STAT1_Jak1', 5.5E-4)
Parameter('kd_STAT1_Jak1', 5.5E-4)
Parameter('ka_STAT2_Jak1', 5.5E-4)
Parameter('kd_STAT2_Jak1', 5.5E-4)
Parameter('ka_STAT3_Jak1', 5.5E-4)
Parameter('kd_STAT3_Jak1', 5.5E-4)
Parameter('ka_STAT4_Jak1', 5.5E-4)
Parameter('kd_STAT4_Jak1', 5.5E-4)
Parameter('ka_STAT5_Jak1', 5.5E-4)
Parameter('kd_STAT5_Jak1', 5.5E-4)

Parameter('ka_STAT1_Jak2', 5.5E-4)
Parameter('kd_STAT1_Jak2', 5.5E-4)
Parameter('ka_STAT2_Jak2', 5.5E-4)
Parameter('kd_STAT2_Jak2', 5.5E-4)
Parameter('ka_STAT3_Jak2', 5.5E-4)
Parameter('kd_STAT3_Jak2', 5.5E-4)
Parameter('ka_STAT4_Jak2', 5.5E-4)
Parameter('kd_STAT4_Jak2', 5.5E-4)
Parameter('ka_STAT5_Jak2', 5.5E-4)
Parameter('kd_STAT5_Jak2', 5.5E-4)

Parameter('ka_STAT1_Jak3', 5.5E-4)
Parameter('kd_STAT1_Jak3', 5.5E-4)
Parameter('ka_STAT2_Jak3', 5.5E-4)
Parameter('kd_STAT2_Jak3', 5.5E-4)
Parameter('ka_STAT3_Jak3', 5.5E-4)
Parameter('kd_STAT3_Jak3', 5.5E-4)
Parameter('ka_STAT4_Jak3', 5.5E-4)
Parameter('kd_STAT4_Jak3', 5.5E-4)
Parameter('ka_STAT5_Jak3', 5.5E-4)
Parameter('kd_STAT5_Jak3', 5.5E-4)

Parameter('ka_STAT1_Tyk2', 5.5E-4)
Parameter('kd_STAT1_Tyk2', 5.5E-4)
Parameter('ka_STAT2_Tyk2', 5.5E-4)
Parameter('kd_STAT2_Tyk2', 5.5E-4)
Parameter('ka_STAT3_Tyk2', 5.5E-4)
Parameter('kd_STAT3_Tyk2', 5.5E-4)
Parameter('ka_STAT4_Tyk2', 5.5E-4)
Parameter('kd_STAT4_Tyk2', 5.5E-4)
Parameter('ka_STAT5_Tyk2', 5.5E-4)
Parameter('kd_STAT5_Tyk2', 5.5E-4)
...
Parameter('ka_IFNg_2xR1', 5.5E-4)
Parameter('kd_IFNg_2xR1', 5.5E-4)
Parameter('ka_IFNgR1_R2', 5.5E-4)
...
Monomer('IFNGR1', ['r1', 'r2', 'r3'])
Monomer('IFNGR2', ['r1', 'r2', 'r3'])
...
Initial(IFNGR1(r1=None, r2=None, r3=None), IFNGR1_IC)
Initial(IFNGR2(r1=None, r2=None, r3=None), IFNGR2_IC)
...
# Type 2 IFN
Observable('Active_IFNg_Receptor', Tyk2(s1=8,status='active') % Tyk2(s1=7,status='active') % Jak1(s1=6,status='active') % Jak1(s1=5,status='active') % IFNGR2(r1=3, r3=7) % IFNGR1(r1=1, r2=3, r3=5) % IFN_gamma(s1=1, s2=2) % IFNGR1(r1=2, r2=4, r3=6) % IFNGR2(r1=4, r3=8))
# IL21
...
# ---------------------
Rule('Jak1_STAT1', Jak1(status='active') + STAT1(p1='U') | Jak1(status='active') + STAT1(p1='P'), ka_STAT1_Jak1, kd_STAT1_Jak1)
Rule('Jak1_STAT2', Jak1(status='active') + STAT2(p1='U') | Jak1(status='active') + STAT2(p1='P'), ka_STAT2_Jak1, kd_STAT2_Jak1)
Rule('Jak1_STAT3', Jak1(status='active') + STAT3(p1='U') | Jak1(status='active') + STAT3(p1='P'), ka_STAT3_Jak1, kd_STAT3_Jak1)
Rule('Jak1_STAT4', Jak1(status='active') + STAT4(p1='U') | Jak1(status='active') + STAT4(p1='P'), ka_STAT4_Jak1, kd_STAT4_Jak1)
Rule('Jak1_STAT5', Jak1(status='active') + STAT5(p1='U') | Jak1(status='active') + STAT5(p1='P'), ka_STAT5_Jak1, kd_STAT5_Jak1)

Rule('Jak2_STAT1', Jak2(status='active') + STAT1(p1='U') | Jak2(status='active') + STAT1(p1='P'), ka_STAT1_Jak2, kd_STAT1_Jak2)
Rule('Jak2_STAT2', Jak2(status='active') + STAT2(p1='U') | Jak2(status='active') + STAT2(p1='P'), ka_STAT2_Jak2, kd_STAT2_Jak2)
Rule('Jak2_STAT3', Jak2(status='active') + STAT3(p1='U') | Jak2(status='active') + STAT3(p1='P'), ka_STAT3_Jak2, kd_STAT3_Jak2)
Rule('Jak2_STAT4', Jak2(status='active') + STAT4(p1='U') | Jak2(status='active') + STAT4(p1='P'), ka_STAT4_Jak2, kd_STAT4_Jak2)
Rule('Jak2_STAT5', Jak2(status='active') + STAT5(p1='U') | Jak2(status='active') + STAT5(p1='P'), ka_STAT5_Jak2, kd_STAT5_Jak2)

Rule('Jak3_STAT1', Jak3(status='active') + STAT1(p1='U') | Jak3(status='active') + STAT1(p1='P'), ka_STAT1_Jak3, kd_STAT1_Jak3)
Rule('Jak3_STAT2', Jak3(status='active') + STAT2(p1='U') | Jak3(status='active') + STAT2(p1='P'), ka_STAT2_Jak3, kd_STAT2_Jak3)
Rule('Jak3_STAT3', Jak3(status='active') + STAT3(p1='U') | Jak3(status='active') + STAT3(p1='P'), ka_STAT3_Jak3, kd_STAT3_Jak3)
Rule('Jak3_STAT4', Jak3(status='active') + STAT4(p1='U') | Jak3(status='active') + STAT4(p1='P'), ka_STAT4_Jak3, kd_STAT4_Jak3)
Rule('Jak3_STAT5', Jak3(status='active') + STAT5(p1='U') | Jak3(status='active') + STAT5(p1='P'), ka_STAT5_Jak3, kd_STAT5_Jak3)

Rule('Tyk2_STAT1', Tyk2(status='active') + STAT1(p1='U') | Tyk2(status='active') + STAT1(p1='P'), ka_STAT1_Tyk2, kd_STAT1_Tyk2)
Rule('Tyk2_STAT2', Tyk2(status='active') + STAT2(p1='U') | Tyk2(status='active') + STAT2(p1='P'), ka_STAT2_Tyk2, kd_STAT2_Tyk2)
Rule('Tyk2_STAT3', Tyk2(status='active') + STAT3(p1='U') | Tyk2(status='active') + STAT3(p1='P'), ka_STAT3_Tyk2, kd_STAT3_Tyk2)
Rule('Tyk2_STAT4', Tyk2(status='active') + STAT4(p1='U') | Tyk2(status='active') + STAT4(p1='P'), ka_STAT4_Tyk2, kd_STAT4_Tyk2)
Rule('Tyk2_STAT5', Tyk2(status='active') + STAT5(p1='U') | Tyk2(status='active') + STAT5(p1='P'), ka_STAT5_Tyk2, kd_STAT5_Tyk2)
...
#Rule('IL2_binds_IL2RA', IL2RA(r1=None) + IL2(s1=None) | IL2RA(r1=1)%IL2(s1=1), ka_IL2RA_IL2, kd_IL2RA_IL2)
#Rule('RIL2_binds_Gamma', IL2RA(r1=1)%IL2(s1=1, s2=None) + Gamma_c(r1=None) | IL2RA(r1=1)%IL2(s1=1, s2=2)%Gamma_c(r1=2), ka_RIL2_Gamma, kd_RIL2_Gamma)
#Rule('IL2_receptor_state_change', Jak1(s1=3,status='inactive')%IL2RA(r1=1, r3=3)%IL2(s1=1, s2=2)%Gamma_c(r1=2, r3=4)%Jak3(s1=4,status='inactive') | Jak1(s1=3,status='active')%IL2RA(r1=1, r3=3)%IL2(s1=1, s2=2)%Gamma_c(r1=2, r3=4)%Jak3(s1=4,status='active'), IL2_activation, IL2_deactivation)
...
Rule('IFNGR1_binds_Jak1', IFNGR1(r3=None) + Jak1(s1=None) | IFNGR1(r3=1)%Jak1(s1=1), ka_IFNGR1_Jak1, kd_IFNGR1_Jak1)
Rule('IFNGR2_binds_Tyk2', IFNGR2(r3=None) + Tyk2(s1=None) | IFNGR2(r3=1)%Tyk2(s1=1), ka_IFNGR2_Tyk2, kd_IFNGR2_Tyk2)

Rule('IFNg_bind_R1', IFNGR1(r1=None, r2=None) + IFN_gamma(s1=None,s2=None) | IFNGR1(r1=1, r2=None)%IFN_gamma(s1=1,s2=None), ka_IFNg_R1, kd_IFNg_R1)
Rule('IFNg_bind_2xR1', IFNGR1(r1=1, r2=None)%IFN_gamma(s1=1,s2=None) + IFNGR1(r1=None, r2=None) | IFNGR1(r1=1, r2=None)%IFN_gamma(s1=1,s2=2)%IFNGR1(r1=2, r2=None), ka_IFNg_2xR1, kd_IFNg_2xR1)
Rule('IFNgR1_bind_R2', IFNGR1(r2=None)%IFN_gamma() + IFNGR2(r1=None) | IFNGR2(r1=1)%IFNGR1(r2=1)%IFN_gamma(), ka_IFNgR1_R2, kd_IFNgR1_R2)
Rule('IFNg_receptor_state_change', Tyk2(s1=8,status='inactive')%Tyk2(s1=7,status='inactive')%Jak1(s1=6,status='inactive')%Jak1(s1=5,status='inactive')%IFNGR2(r1=3, r3=7)%IFNGR1(r1=1, r2=3, r3=5)%IFN_gamma(s1=1,s2=2)%IFNGR1(r1=2, r2=4, r3=6)%IFNGR2(r1=4, r3=8) | Tyk2(s1=8,status='active') % Tyk2(s1=7,status='active') % Jak1(s1=6,status='active') % Jak1(s1=5,status='active') % IFNGR2(r1=3, r3=7) % IFNGR1(r1=1, r2=3, r3=5) % IFN_gamma(s1=1, s2=2) % IFNGR1(r1=2, r2=4, r3=6) % IFNGR2(r1=4, r3=8), IFNg_activation, IFNg_deactivation)
# -----------
# IL12 family
# -----------

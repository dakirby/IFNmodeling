...
Parameter('volCP', 4/3 * 3.14159 * (3.6E-6)**3)
...
Parameter('STAT1_IC', 10000)
Parameter('STAT2_IC', 10000)
Parameter('STAT3_IC', 10000)
Parameter('STAT4_IC', 10000)
Parameter('STAT5_IC', 10000)

Parameter('SOCS2_IC', 0)

# Phosphorylation rates
# MAPK in E. coli has kcat ~ 0.5 per second accoriding to Bionumbers.
Parameter('kp_STAT1_Jak1', 1E-6)
Parameter('kp_STAT2_Jak1', 1E-6)
Parameter('kp_STAT3_Jak1', 1E-6)
Parameter('kp_STAT4_Jak1', 1E-6)
Parameter('kp_STAT5_Jak1', 1E-6)

Parameter('kp_STAT1_Jak2', 1E-6)
Parameter('kp_STAT2_Jak2', 1E-6)
Parameter('kp_STAT3_Jak2', 1E-6)
Parameter('kp_STAT4_Jak2', 1E-6)
Parameter('kp_STAT5_Jak2', 1E-6)

Parameter('kp_STAT1_Jak3', 1E-6)
Parameter('kp_STAT2_Jak3', 1E-6)
Parameter('kp_STAT3_Jak3', 1E-6)
Parameter('kp_STAT4_Jak3', 1E-6)
Parameter('kp_STAT5_Jak3', 1E-6)

Parameter('kp_STAT1_Tyk2', 1E-6)
Parameter('kp_STAT2_Tyk2', 1E-6)
Parameter('kp_STAT3_Tyk2', 1E-6)
Parameter('kp_STAT4_Tyk2', 1E-6)
Parameter('kp_STAT5_Tyk2', 1E-6)

Parameter('ku_STAT1', 1E-3)
Parameter('ku_STAT2', 1E-3)
Parameter('ku_STAT3', 1E-3)
Parameter('ku_STAT4', 1E-3)
Parameter('ku_STAT5', 1E-3)

# SOCS binding rates
Parameter('ka_IFNGR1_SOCS', 1E3)
Parameter('kd_IFNGR1_SOCS', 1E-3)
...
# Type 1 IFN
Parameter('ka_IFNAR1_Tyk2', 1E4)
Parameter('kd_IFNAR1_Tyk2', 1E-4)
Parameter('ka_IFNAR2_Jak1', 1E4)
Parameter('kd_IFNAR2_Jak1', 1E-4)
Parameter('IFNa_activation', 1E4)
Parameter('IFNa_deactivation', 1E-4)
Parameter('IFNb_activation', 1E4)
Parameter('IFNb_deactivation', 1E-4)
...
# Type 2 IFN
Parameter('ka_IFNGR1_Jak1', 1E3)
Parameter('kd_IFNGR1_Jak1', 1E-3)
Parameter('ka_IFNGR2_Tyk2', 1E3)
Parameter('kd_IFNGR2_Tyk2', 1E-3)

Parameter('ka_R1_bind_R1', 0.55*0.1 / (5)**2)
Parameter('kd_R1_bind_R1', 200) # Chosen by hand to get EC50 where it should be

Parameter('ka_IFNg_R1', 0.5E10 / (1E-9 * 6.022E23))
Parameter('kd_IFNg_R1', 1)

Parameter('ka_IFNgR1_R2', 0.18*0.1 / (5)**2)
Parameter('kd_IFNgR1_R2', 200)# Chosen by hand to get EC50 where it should be

Parameter('IFNg_activation', 1E4)
Parameter('IFNg_deactivation', 1E-4)
...
Initial(SOCS2(s1=None), SOCS2_IC)
# =============================================================================
# # Observables
...
# STATs
Observable('totalSTAT1', STAT1())
Observable('totalSTAT3', STAT3())
...
Rule('IFNgR1_bind_R1', IFNGR1(r1=None, r2=None, r4=None) + IFNGR1(r1=None, r2=None, r4=None) | IFNGR1(r1=None, r2=None, r4=1)%IFNGR1(r1=None, r2=None, r4=1), ka_R1_bind_R1, kd_R1_bind_R1)
Rule('IFNgR1_bind_R2', IFNGR1(r1=None, r2=None, r4=ANY) + IFNGR2(r1=None) | IFNGR1(r1=None, r2=2, r4=ANY)%IFNGR2(r1=2), ka_IFNgR1_R2, kd_IFNgR1_R2)
Rule('IFNg_bind_R1', IFNGR1(r1=None, r2=ANY, r4=20)%IFNGR1(r1=None, r2=ANY, r4=20) + IFN_gamma(s1=None,s2=None) | IFNGR1(r1=1, r2=ANY, r4=20)%IFN_gamma(s1=1,s2=2)%IFNGR1(r1=2, r2=ANY, r4=20), ka_IFNg_R1, kd_IFNg_R1)
...
Rule('IFNGR1_blocked_SOCS', IFNGR1(r3=None) + SOCS2(s1=None) | IFNGR1(r3=1)%SOCS2(s1=1), ka_IFNGR1_SOCS, kd_IFNGR1_SOCS)
# -----------
# IL12 family
# -----------

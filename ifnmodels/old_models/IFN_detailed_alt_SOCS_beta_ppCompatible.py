...
Parameter('I', 6.022E9) # = IFN*volEC*NA for IFN=1E-9
...
Parameter('k_a2', 8.30e-13)   # 5e6/(NA*volEC)  ligand-monomer binding  (scaled)
...
Rule('IFN_bind_R2', IFNAR2(re=None,ri=WILD,rs=None,loc='out') + IFN_beta(r1=None,r2=None) | IFNAR2(re=1,ri=WILD,rs=None,loc='out')%IFN_beta(r1=1,r2=None), k_a2, k_d2 )
...
Rule('IR2_bind_R1', IFNAR2(re=1,ri=WILD,rs=None,loc='out')%IFN_beta(r1=1,r2=None) + IFNAR1(re=None,ri=None,loc='out') | IFNAR1(re=1,ri=None,loc='out')%IFN_beta(r1=1,r2=2)%IFNAR2(re=2,ri=WILD,rs=None,loc='out'), k_a4, k_d4)

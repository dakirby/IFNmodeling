...
Rule('IFN_bind_R2', IFNAR2(re=None,ri=WILD,rs=None,loc='out') + IFN_alpha2(r1=None,r2=None) | IFNAR2(re=1,ri=WILD,rs=None,loc='out')%IFN_alpha2(r1=1,r2=None), ka2, kd2 )
...
Rule('IR2_bind_R1', IFNAR2(re=1,ri=WILD,rs=None,loc='out')%IFN_alpha2(r1=1,r2=None) + IFNAR1(re=None,ri=None,loc='out') | IFNAR1(re=1,ri=None,loc='out')%IFN_alpha2(r1=1,r2=2)%IFNAR2(re=2,ri=WILD,rs=None,loc='out'), ka4, kd4)
